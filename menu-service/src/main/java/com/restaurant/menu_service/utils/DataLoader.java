package com.restaurant.menu_service.utils;
...
public class DataLoader implements CommandLineRunner {
    ...
    private final ServiceSecurityRepository menuServiceSecurityRepository;
    ...
    public void run(String... args) throws Exception {
        ...
        ServiceSecurity serviceSecurity = menuServiceSecurityRepository.findByServiceName("menu_service").orElse(null);
        if (serviceSecurity == null) {
            serviceSecurity = ServiceSecurity.builder().serviceName("menu_service").
            ...
            menuServiceSecurityRepository.save(serviceSecurity);
